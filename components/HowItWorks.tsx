    ...
    <section className="py-20 px-4">
      <div className="max-w-7xl mx-auto">
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-16 left-full w-full h-0.5 bg-gray-800 -z-10" />
              )}
              ...
              <div className="text-center">
                ...
                >
                  <div className="w-24 h-24 border border-gray-800 rounded flex items-center justify-center mb-4 mx-auto">
                    <span className="text-xs font-mono text-gray-600">{step.icon}</span>
                  </div>
                </motion.div>
        ...
        <motion.div
          ...
          className="mt-16 bg-gray-950 border border-gray-800 rounded p-8 text-center"
        >
